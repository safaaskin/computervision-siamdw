...
addpath('D:/Chrome Downloads/SiamDW/vot/vot-toolkit'); toolkit_path; % Make sure that VOT toolkit is in the path

pwd = ['D:/Chrome Downloads/SiamDW/vot/vot-toolkit/', 'workspace/', '2016'] % year is a str (can not be a number)
